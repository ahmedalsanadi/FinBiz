...
const PreFooterSection = () => {
  ...
  return (
    <div className='px-2 py-20 container mx-auto '>
      <div
  className="bg-veryDarkGray  pl-12 pr-12 md:pl-16 md:pr-4 pt-8 pb-4 md:py-4  flex flex-col md:flex-row items-center justify-between rounded-3xl shadow-md overflow-hidden "
  data-aos="fade-up" 
>
  <div
    className="flex-1 md:pr-8 mb-8 md:mb-2"
    data-aos="fade-right"
  >
