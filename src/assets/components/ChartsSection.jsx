  ...
  return (
    <section className='bg-veryDarkGray container mx-auto p-4'>
      <div className='grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 gap-6'>
        ...
        {/* Card 1: Profit */}
        <div className='col-span-12 md:col-span-4 lg:col-span-4 p-8 bg-darkGray rounded-3xl'>
        ...
        <div className='col-span-12 md:col-span-2 lg:col-span-2 p-6 bg-darkGray rounded-lg flex flex-col justify-between'>
        ...
        <div className='col-span-12 md:col-span-8 lg:col-span-8 p-6 bg-darkGray rounded-lg'>
